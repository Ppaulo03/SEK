...
while no_gasoduto:
    ...
    while gasoduto_com_cano and distancia_media(usl) < 15 and distancia_media(usf) > 10:
        acompanhar_gasoduto(4,10)
        
        if gasoduto_com_cano and distancia_media(usl) < 15 and distancia_media(usf) > 10:
            garra_g.on_for_degrees(20,-1200)
            sleep(0.1)
            global gasoduto_com_cano
            gasoduto_com_cano = (distancia_media(usl) < 25)
